    ...
    return (
        <div className="bg-[#0167BB]">
            <Container>
                ...
                <Link to='/be-trainer'>
                    <button className="btn bg-[#0167BB] hover:bg-[#219bff] w-full text-white rounded-md uppercase hover:scale-105 hover:-skew-x-3 hover:border-0" >Become a Trainer</button>
                </Link>
