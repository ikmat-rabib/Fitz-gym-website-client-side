            ...
            <Container>
                ...
                <div className="flex justify-center">
                    <form action="" className="space-x-10 ">
                        ...
                        <input className="btn bg-[#0167BB] hover:bg-[#219bff] text-white rounded-md uppercase hover:scale-110 hover:-skew-x-12 hover:border-0" type="submit" value="Join Newsletter" />
                    </form>
                </div>
            </Container>
        </div>
